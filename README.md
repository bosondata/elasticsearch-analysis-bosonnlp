...
####方法一
```
$ sudo bin/plugin install https://github.com/bosondata/elasticsearch-analysis-bosonnlp/releases/download/1.2.1-beta/elasticsearch-analysis-bosonnlp-1.2.1-beta.zip
```
