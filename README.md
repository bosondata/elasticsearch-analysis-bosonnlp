...
####方法一
```markdown
$ bin/plugin -u https://github.com/bosondata/elasticsearch-analysis-bosonnlp/files/179342/elasticsearch-analysis-bosonnlp-beta-plugin.zip -i elasticsearch-analysis-bosonnlp
