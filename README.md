...
####方法一
```
$ bin/plugin -u https://github.com/bosondata/elasticsearch-analysis-bosonnlp/releases/download/1.0.0-beta/elasticsearch-analysis-bosonnlp-1.0.0-beta-plugin.1.zip -i elasticsearch-analysis-bosonnlp
```
