...
####方法一
```
$ sudo bin/plugin install https://github.com/bosondata/elasticsearch-analysis-bosonnlp/releases/download/1.1.0-beta/elasticsearch-analysis-bosonnlp-1.1.0-beta.zip
```
